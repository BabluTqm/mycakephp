            ...
            <div class="card-body px-0 pb-2">
              ...
              <div class="card card-plain">
                <div class="card-header border">
                  <h4 class="font-weight-bolder text-center">Add New User</h4>
                  <p class="mb-0"> </p>
                  ...
                  <?php echo $this->Form->control('password', [ 'style' => 'width:366px;', 'class' => 'form-control' , 'required' => false]); ?>
                  ...
                  <?php echo $this->Form->control('user_profile.images', [ 'type' => 'file' , 'style' => 'width:366px;', 'class' => 'form-control' , 'required' => false]); ?> 
                  
                <div class="text-center">
                <?= $this->Form->button(('Add user') ,['class' => 'btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0']) ?>
                <?= $this->Form->end() ?>
                    </div>
                  </form>
