            ...
            <div class="card-body px-0 pb-2">
              ...
              <div class="card card-plain">
                <div class="card-header border">
                  <h4 class="font-weight-bolder text-center">Update Your Profile</h4>
                  <p class="mb-0"> </p>
                ...
                <div class="card-body">
                   ...
                   <?php echo $this->Form->control('user_profile.image', [ 'type' => 'file' , 'style' => 'width:366px;', 'class' => 'form-control' , 'required' => false]); ?> 
                   <?php  echo $this->Html->image($user->user_profile->profile_image , ['class' => 'avatar avatar-sm me-3 border-radius-lg']); ?>
                    <div class="text-center">
                      <?= $this->Form->button(('Update Profile') ,['class' => 'btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0']) ?>
                      <?= $this->Form->end() ?>
                    </div>
                  </form>
