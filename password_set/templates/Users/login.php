            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <?= $this->Flash->render() ?>
                ...
                <?php echo $this->Form->create() ?>
                  ...
                  <?php echo $this->Form->control('password', [ 'id' => 'myInput' , 'style' => 'width:366px;', 'class' => 'form-control' , 'required' => false]); ?>
                  ...
                  <div class="text-center">
                    ...
                    <?= $this->Form->button(('Sign in') ,['class' => 'btn bg-gradient-primary w-100 my-4 mb-2']) ?>
                    <?= $this->Form->end() ?>
                  ...
                  <p class="mt-4 text-sm text-center">
                    ...
                    <?= $this->Html->link(__('Sign up'), ['action' => 'signup'], ['class' => 'text-primary text-gradient font-weight-bold']) ?>
                  </p>
