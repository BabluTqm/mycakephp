          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Add Cateogry</h6>
              ...
              <div class="card card-plain">
                <div class="card-header border">
                  ...
                  <?php echo $this->Form->create($productCategory); ?>
                   ...
                   <?php echo $this->Form->control('category_name', ['style' => 'width:366px;', 'class' => 'form-control' , 'required' => false]); ?> 
                    ...
                    <div class="text-center">
                      ...
                      <?= $this->Form->button(('Add Category') ,['class' => 'btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0']) ?>
                      <?= $this->Form->end() ?>
                    </div>
                  </form>
